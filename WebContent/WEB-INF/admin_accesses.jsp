                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
			                <div class="fresh-table">
			                    <div class="toolbar">
			                        <button class="btn btn-default" disabled="disabled">Danh sách cookie truy cập: ${soluongtruycap} lượt</button>
			                    </div>
			                    <table id="posts-table" class="table">
			                        <thead>
				                        <tr>
				                            <th data-field="id" data-sortable="true">ID</th>
				                        	<th data-field="name" data-sortable="true">Cookie</th>
				                        	<th data-field="salary" data-sortable="true">Day</th>
				                        	<th data-field="country" data-sortable="true">Last Time</th>
				                        	<th data-field="city" data-sortable="true">Times</th>
				                        	<th data-field="actions">Actions</th>
				                        </tr>
			                        </thead>
			                        <tbody>
			                        	<c:forEach items="${thongtintruycap}" var="truycap">
				                            <tr>
				                            	<td>${truycap.getMaTruyCap()}</td>
				                            	<td>${truycap.getCookie()}</td>
				                            	<td><fmt:formatDate value="${truycap.getNgayTruyCap()}" pattern="yyyy-MM-dd"/></td>
				                            	<td><fmt:formatDate value="${truycap.getThoiGianTruyCap()}" pattern="HH:mm:ss"/></td>
				                            	<td>${truycap.getLuotTruyCap()}</td>
				                            </tr>
			                            </c:forEach>
			                        </tbody>
			                    </table>
