...
<body>
	...
	<div class="container">
		<form class="form-horizontal" action="ChangePosts?mabaiviet=${thongtinchinhsua.getMaBaiViet()}" method="post" enctype="multipart/form-data">
			<jsp:include page="changepostseditor.jsp"/>
			<div class="form-group">
				<label class="control-label col-sm-3"></label>
				<div class="col-sm-9 col-xs-9">
					<center>
						<button type="submit" class="btn btn-success">Xác nhận <span class="glyphicon glyphicon-send"></span></button>
