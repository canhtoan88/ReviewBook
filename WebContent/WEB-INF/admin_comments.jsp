                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
			                <div class="fresh-table">
			                    <div class="toolbar">
			                        <button class="btn btn-default" disabled="disabled">Danh sách bình luận: ${soluongbinhluan}</button>
			                    </div>
			                    <table id="posts-table" class="table">
			                        <thead>
				                        <tr>
				                        	...
				                        	<th data-field="salary" data-sortable="true">Full Name</th>
			                        ...
			                        <tbody>
			                        	<c:forEach items="${thongtinbinhluan}" var="binhluan">
				                            <tr>
				                            	<td>${binhluan.getMaBinhLuan()}</td>
				                            	<td>${binhluan.getNoiDungBinhLuan()}</td>
				                            	<td>${binhluan.getHoTen()}</td>
				                            	<td><fmt:formatDate value="${binhluan.getThoiGianBinhLuan()}" pattern="yyyy-MM-dd"/></td>
				                            	<td>
				                            		<form action="AdminComments?mabinhluan=${binhluan.getMaBinhLuan()}" method="post">
