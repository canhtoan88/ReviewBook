                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
			                <div class="fresh-table">
			                    <div class="toolbar">
			                        <button class="btn btn-default" disabled="disabled">Danh sách tài khoản: ${soluongtaikhoan}</button>
			                    </div>
			                    <table id="posts-table" class="table">
			                        ...
			                        <tbody>
			                        	<c:forEach items="${thongtinnguoidung}" var="thongtin">
				                            <tr>
				                            	<td>${thongtin.getMaNguoiDung()}</td>
				                            	<td>${thongtin.getTenDangNhap()}</td>
				                            	<td>${thongtin.getHoTen()}</td>
				                            	<td><fmt:formatDate value="${thongtin.getThoiGianDangKy()}" pattern="dd-MM-yyyy"/></td>
				                            	<td>
				                            		<form action="AdminAccounts?manguoidung=${thongtin.getMaNguoiDung()}" method="post">
