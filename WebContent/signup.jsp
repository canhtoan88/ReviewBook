...
<body>
	<form onSubmit="return kiemtramatkhau(this)" class="ctmodal-content-signup animate" action="resignup.jsp" method="" accept-charset="utf-8">
		...
		<div class="ctcontainer">
			...
			<label for="uname"><b>Tên đăng nhập</b></label>
     			...
     			<input class="form-control" type="text" placeholder="Email" name="email" required="email"/>
