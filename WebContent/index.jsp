...
<body>
	...
	<div class="container" style="margin-top: 60px">
		<div class="card-box col-md-3 col-sm-6">
            <div class="card">                            
                <div class="header">
                    <img src="assets/img/doi-thay-doi-khi-chung-ta-thay-doi.jpg"/>
                    <div class="filter"></div>
                    
                    <div class="actions">
                    	<a href="posts.jsp"><button class="btn btn-round btn-fill btn-neutral btn-modern">
                            Đọc thêm
                        </button></a>
                    </div>
                </div>
                ...
                <div class="content">
                    <h6 class="category"><span class="badge">Kỹ năng sống</span></h6>
                    <h4 class="title"><a href="posts.jsp">Đời thay đổi khi chúng ta thay đổi</a></h4>
                    <p class="description">Ngày xửa ngày xưa...</p>
                    <i>Thời gian: 21/4/2018</i>
                </div>                                           
            </div>
         </div>
         <div class="card-box col-md-3 col-sm-6">
            <div class="card">                            
                <div class="header">
                    <img src="assets/img/dung-bao-gio-di-an-mot-minh.jpg"/>
                    <div class="filter"></div>
                ...
                <div class="content">
                    <h6 class="category"><span class="badge">Kinh doanh</span></h6>
                    <h4 class="title"><a href="#">Đừng bao giờ đi ăn một mình</a></h4>
                    <p class="description">Ngày xửa ngày xưa...</p>
                    <i>Thời gian: 21/4/2018</i>
                </div>                                           
            </div>
         ...
         <div class="card-box col-md-3 col-sm-6">
            <div class="card">                            
                <div class="header">
                    <img src="assets/img/ong-gia-va-bien-ca.jpg"/>
                    <div class="filter"></div>
                ...
                <div class="content">
                    <h6 class="category"><span class="badge">Văn học</span></h6>
                    <h4 class="title"><a href="#">Ông già và biển cả</a></h4>
                    <p class="description">Ngày xửa ngày xưa...</p>
                    <i>Thời gian: 21/4/2018</i>
                </div>                                           
            </div>
         ...
         <div class="card-box col-md-3 col-sm-6">
            <div class="card">                            
                <div class="header">
                    <img src="assets/img/chuyen-con-meo-day-hai-au-bay.jpg"/>
                    <div class="filter"></div>
                ...
                <div class="content">
                    <h6 class="category"><span class="badge">Tiểu thuyết</span></h6>
                    <h4 class="title"><a href="#">Chuyện con mèo dạy hải âu bay</a></h4>
                    <p class="description">Ngày xửa ngày xưa...</p>
                    <i>Thời gian: 21/4/2018</i>
                </div>                                           
            </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-9">
				<button class="ctaccordion">KỸ NĂNG SỐNG</button>
				<div class="ctpanel">
				  	<div class="col-sm-6">
				  		<div class="col-xs-12" style="margin-top: 10px">
                            <a href="" title="">
                                <img src="assets/img/ong-gia-va-bien-ca.jpg" alt="" style="width: 100%; max-width: 300px"/>
				  	...
				  	<div class="col-sm-6">
				  		<div class="col-xs-12" style="margin-top: 10px">
                            <div class="col-xs-4" style="padding-left: 0">
                               <a href="" title=""><img style="width: 100%;max-width: 100px" src="assets/img/dung-bao-gio-di-an-mot-minh.jpg" alt="Đừng bao giờ đi ăn một mình"/></a>
                            </div>
                            <div class="col-xs-8">
                               <a href="" title=""><span style="font-size: 17px">Đừng bao giờ đi ăn một mình</span></a>
                               <p><i>21/05/2018</i></p>
                            </div>
                        </div>
                        <div class="col-xs-12" style="margin-top: 10px">
                    ...
                    <div class="col-xs-12 text-center">
                        <a href="" title=""><button type="button" class="btn" style="background-color: #00b900; color: #ffff1a; margin-bottom: 5px">Xem thêm</button></a>
                    </div>
				</div>
                
				<button class="ctaccordion">KINH DOANH</button>
				<div class="ctpanel">
				  	<div class="col-sm-6">
                        <div class="col-xs-12" style="margin-top: 10px">
                            <a href="" title="">
				...
				<button class="ctaccordion">VĂN HỌC</button>
				<div class="ctpanel">
				  	<div class="col-sm-6">
                        <div class="col-xs-12" style="margin-top: 10px">
                            <a href="" title="">
				...
				<button class="ctaccordion">TIỂU THUYẾT</button>
				<div class="ctpanel">
				  	<div class="col-sm-6">
                        <div class="col-xs-12" style="margin-top: 10px">
                            <a href="" title="">
			...
			<div class="col-sm-3">
                <div class="col-xs-12 cthightlight">
