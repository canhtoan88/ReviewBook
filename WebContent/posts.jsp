...
<body>
  		...
  		<div class="col-sm-11 container-fluid">
    		...
    		<div class="collapse navbar-collapse" id="collapse-1">
		    	...
		    	<div class="center-block">
		    		<button onclick="document.getElementById('signin').style.display='block'" class="btn btn-primary" type="button" style="margin: 7px 0;">Đăng nhập</button>
		    		<button onclick="document.getElementById('signup').style.display='block'" class="btn btn-primary" type="button" style="margin: 7px">Đăng ký</button>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-9">
				<h1 class="modal-title"><b>Tiêu đề bài viết</b></h1>
                <p><i>23/5/2018</i></p>
